...
<body>
    ...
    <div class="Delete_Post"> <!--similar layout with add post-->
        <!--Content-->
    <div class="container">
        
        <!--Add Posts Form-->
        <div class="deletePost_form">
            <h1>Delete Post</h1>
            ...
            <form action="" method="POST">
                ...
                <label>Post ID: </label>
                <input type="text" id="post_id" name="post_id" placeholder="Enter Post Title"/>
                
                <br><br>
                        
                <input type="submit" id="btn_confirm" name="btn_confirm" value="Confirm"/>
                ...
                <!--
                <button type="submit" id="btn_upload" name="btn_upload">Upload</button>
                &nbsp;
                <button type="submit" id="btn_cancel" name="btn_cancel">Cancel</button>
                -->
