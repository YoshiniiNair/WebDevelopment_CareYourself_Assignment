...
<body>
    ...
    <header><!--class="u-clearfix u-header u-header" id="sec-cb5a"-->
        ...
        <div class="topic-container">
            ...
            <div class="body">
                ...
                //$sql = "SELECT posts.*, users.*FROM posts, users WHERE posts.user_id=users.user_id";
	...
	if ($result)
	{
		...
		{ 
                    ...
                    echo '<div class="username"><a href="userProfile.php?user_id=' . $row['user_id'] . '"><label class="username">' . $row['username'] . '</label></a></div>';
                    echo '</div>';
                    echo '<div class="content">';
                    echo '<div class="viewPost">';
                    echo '<label class="viewPost"> Post ID： ' . $row['post_id'] . '<br> Post Content: ' . $row['post_content'] . '</label>';
                    echo '</div>';
                    echo '</div>';
                    echo '<br>';
                    echo '<hr>';
            ...
            <div class="btn _aasm">
                        ...
                        <div class="option_dropdown">
                            ...
                            <div id="myDropdown" class="option_dropContent">
                                <a href="updatePost.php?post_id=<?php echo $row['post_id'];?>" id="btn_updatePost" name="btn_updatePost">Edit</a>
                                <a href="deletePost.php" id="btn_deletePost" name="btn_deletePost">Delete</a>
                            </div>
                        </div>
                        <script>
