...
<body>
    ...
    <div class="posts">
        ...
        <div class="addPost">
            <input type="submit" value="Add Post" name="addPost" id="addPost" formaction="addPost.php">
        </div>
		...
		while($row = $result->fetch_assoc())
            ...
            <div class="table-row">
                ...
                <div class="last-reply">
                    Oct 12 2021
                    <br>By <b><a href="">User1</a></b>
                </div>
                
                <div class="edit">
                    <button type="submit" id="btn_menu" name="btn_menu" style="border:none;  background-color: #F0E68C;">
