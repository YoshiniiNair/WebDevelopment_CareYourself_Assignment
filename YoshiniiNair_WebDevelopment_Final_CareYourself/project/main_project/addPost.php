...
<body>
	...
	$sql1 = "SELECT user_id FROM users WHERE username LIKE '%$username%'";
...
if(isset($_POST['btn_upload']))
{
 ...
 $sql2 = "INSERT INTO posts(user_id, post_title, post_content) VALUES('$user_id', '$post_title', '$post_content')";
